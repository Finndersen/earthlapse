...
| **Volume** | measured: 49,215,745 bytes raw zip; 186,488,764 bytes extracted GeoJSON; 14,945 total features (14,108 `Type == "POLITY"`); curated to the 28-lineage empire roster: 1,755 resolved member segments thinned to 803 territory snapshots (`sources/cliopatria/README.md` "Measured volume") |
