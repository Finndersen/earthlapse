 ...
 *  renders clipped outside the track. Purely presentational — the ruler no longer drags (the
 *  visible window is fixed to the full domain; see Timeline's own doc comment). */
